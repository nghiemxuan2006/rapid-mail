...
import { UpdateSignatureBody, CreateSignatureBody, UpdateMySignatureBody } from '../schema/signature.schema';
...
export const importGmailSignaturesHandler = async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const importGmailSignaturesByAccountHandler = async (req: Request<{ accountId: string }>, res: Response, next: NextFunction) => {
    try {
        const userId = requireUserId(req);
...
export const getDefaultSignatureHandler = async (req: Request, res: Response, next: NextFunction) => {
    try {
        const userId = requireUserId(req);
